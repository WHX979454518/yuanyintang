...
public class EditMyReleaseDialog {
    private String path;
    private DiaLogBuilder dialog;

    public static EditMyReleaseDialog newInstance() {
        return new EditMyReleaseDialog();
    }

    public EditMyReleaseDialog showDialog(final Context mContext, final String path) {
        this.path = path;
