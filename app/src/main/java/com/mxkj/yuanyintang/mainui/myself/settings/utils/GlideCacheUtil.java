...
/**
 * Created by LiuJie on 2017/11/6.
 */
...
// BusUtil.getBus().post(new GlideCacheClearSuccessEvent());
    ...
    public void clearImageAllCache(final Context context) {
        ...
        String gifDir = Constants.Path.APP_PATH+File.separator+"gif";
        deleteFolderFile(gifDir, true);
    }
    ...
    public String getCacheSize(Context context) {
        try {
            ...
            long folderSize2 = getFolderSize(new File(Constants.Path.APP_PATH+File.separator+"gif"));
