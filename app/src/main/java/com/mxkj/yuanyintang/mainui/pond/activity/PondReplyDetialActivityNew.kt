...
class PondReplyDetialActivityNew : StandardUiActivity() {
    ...
    internal var ll_to_pond: LinearLayout? = null
    ...
    private fun initHeadView() {
        ...
        val ll_to_pond = headView!!.findViewById<LinearLayout>(R.id.ll_to_pond)
    ...
    override fun initEvent() {
        ...
        interfaceRefreshLoadMore = InterfaceRefreshLoadMore(swipe_refresh, this@PondReplyDetialActivityNew, object : InterfaceRefreshLoadMore.RefreshLoadMoreCallback {
    ...
    @OnClick(R.id.finish, R.id.more_menu, R.id.et_pinglun, R.id.img_show_emoji, R.id.btn_comment)
    fun onViewClicked(view: View) {
        when (view.id) {
            R.id.finish -> finish()
            R.id.more_menu -> {
                if (!CacheUtils.getBoolean(this@PondReplyDetialActivityNew, Constants.User.IS_LOGIN, false)) {
    ...
    private fun initBaseInfo() {
        NetWork.getPondReplyDetialInfo(this@PondReplyDetialActivityNew, pondCommentId, object : NetWork.TokenCallBack {
    ...
    private fun initPondDetial() {
        NetWork.getPondDetialInfo(this@PondReplyDetialActivityNew, pondId, object : NetWork.TokenCallBack {
            override fun doNext(resultData: String, headers: Headers?) {
                ...
                ll_to_pond!!.setOnClickListener {
                    val intent = Intent(this@PondReplyDetialActivityNew, PondDetialActivityNew::class.java)
                    val bundle = Bundle()
    ...
    private fun initHeaderEvent() {
        if (dataBean != null) {
            ...
            RxView.clicks(img_icon!!).throttleFirst(3, TimeUnit.SECONDS).subscribe {
                val intent = Intent(this@PondReplyDetialActivityNew, MusicIanDetailsActivity::class.java)
                val bundle = Bundle()
            ...
            img_agree!!.setImageResource(if (dataBean!!.is_agree == 1) R.drawable.agreed else R.drawable.disagree)
            tv_agree_num!!.setTextColor(if (dataBean!!.is_agree == 1)
                ContextCompat.getColor(this@PondReplyDetialActivityNew, R.color.base_red)
            else
                ContextCompat.getColor(this@PondReplyDetialActivityNew, R.color.grey_a6_text))
            ll_agree!!.setOnClickListener {
                val params = HttpParams()
                params.put("type", 6.toString() + "")
                params.put("item_id", dataBean!!.id.toString() + "")
                NetWork.agree(this@PondReplyDetialActivityNew, params, object : NetWork.TokenCallBack {
                        ...
                        try {
                            ...
                            if (code == 200) {
                                if (dataBean!!.is_agree == 1) {
                                    ...
                                    tv_agree_num!!.setTextColor(ContextCompat.getColor(this@PondReplyDetialActivityNew, R.color.grey_a6_text))
                                    dataBean!!.is_agree = 0
                                    dataBean!!.agrees = dataBean!!.agrees - 1
                                } else {
                                    img_agree!!.setImageResource(R.drawable.agreed)
                                    tv_agree_num!!.text = (dataBean!!.agrees + 1).toString() + ""
                                    tv_agree_num!!.setTextColor(ContextCompat.getColor(this@PondReplyDetialActivityNew, R.color.base_red))
                                    dataBean!!.is_agree = 1
                ...
                GetMusicInfo.getMusicDetial(this, music_id, object : GetMusicInfo.SetBeanData {
                    override fun setBeanData(dataBean: MusicInfo.DataBean?) {
                        ...
                        ll_music!!.setOnClickListener {
                            PlayCtrlUtil.play(this@PondReplyDetialActivityNew,music_id,0)
    ...
    companion object {
        val POND_COMMENTID = "com.mxkj.yuanyintang.ui.pond.comment_id"
    }
}
