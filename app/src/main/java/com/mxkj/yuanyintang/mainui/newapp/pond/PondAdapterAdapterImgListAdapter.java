...
public class PondAdapterAdapterImgListAdapter extends BaseQuickAdapter {
    private List<String> dataList;
    List<DynamicBean.DataBean.ImglistInfoBean> imglist_info;


    public PondAdapterAdapterImgListAdapter(@LayoutRes int layoutResId, @Nullable List data, List<DynamicBean.DataBean.ImglistInfoBean> imglist_info) {
