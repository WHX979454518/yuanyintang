...
import static com.mxkj.yuanyintang.mainui.emotionkeyboard.emotionkeyboardview.EmotionKeyboard.COMMENT_SUCCESS_POND;
import static com.mxkj.yuanyintang.mainui.emotionkeyboard.emotionkeyboardview.EmotionKeyboard.IS_POND;

@SuppressLint("ValidFragment")
public class PondDetialReplyDialogFrag extends DialogFragment implements View.OnClickListener {
    ...
    public PondDetialReplyDialogFrag(String hintText, FragmentManager manager, int pid, int fid, successCallBack callBack) {
    ...
    public void onClick(@NonNull View view) {
        switch (view.getId()) {
            case R.id.btn_comment:
                if (getActivity()!=null&& CacheUtils.INSTANCE.getBoolean(getActivity(),Constants.User.IS_LOGIN, false)) {
//                    v2/api/topcom
                    NetWork.INSTANCE.addPondCommentReply(getActivity(), fid, pid, et_pinglun.getText().toString(), new NetWork.TokenCallBack() {
            ...
            case R.id.img_show_emoji:
                if (emotionMainFragment != null && emotionMainFragment.mEmotionKeyboard != null) {
    ...
    private void registerCommentReceiver() {
        ...
        filter = new IntentFilter(COMMENT_SUCCESS_POND);
