...
public abstract class BGABasePopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    public BGABasePopupWindow(@NonNull Activity activity, @LayoutRes int layoutId, View anchorView, int width, int height) {
    ...
    private void init(@NonNull Activity activity, View anchorView) {
