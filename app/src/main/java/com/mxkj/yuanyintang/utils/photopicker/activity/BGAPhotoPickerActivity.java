...
import com.mxkj.yuanyintang.utils.photopicker.util.BGASpaceItemDecoration;

import java.io.File;
import java.util.ArrayList;

import com.mxkj.yuanyintang.utils.photopicker.adapter.BGAPhotoPickerAdapter;
import com.mxkj.yuanyintang.utils.photopicker.imageloader.BGARVOnScrollListener;
import com.mxkj.yuanyintang.utils.photopicker.model.BGAImageFolderModel;
import com.mxkj.yuanyintang.utils.photopicker.pw.BGAPhotoFolderPw;
import com.mxkj.yuanyintang.utils.photopicker.util.BGAAsyncTask;
import com.mxkj.yuanyintang.utils.photopicker.util.BGAImageCaptureManager;
import com.mxkj.yuanyintang.utils.photopicker.util.BGALoadPhotoTask;
...
public class BGAPhotoPickerActivity extends BGAPPToolbarActivity implements BGAOnItemChildClickListener, BGAAsyncTask.Callback<ArrayList<BGAImageFolderModel>> {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        toPreview = getViewById(R.id.toPreview);
        ...
        toPreview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(mPicAdapter.getSelectedImages().size()<1){
                    Toast.makeText(BGAPhotoPickerActivity.this,"请选择照片后在预览",Toast.LENGTH_SHORT).show();
                }else {
                    startActivityForResult(BGAPhotoPickerPreviewActivity.newIntent(BGAPhotoPickerActivity.this, mMaxChooseCount, mPicAdapter
                                    .getSelectedImages(), mPicAdapter
                                    .getSelectedImages(), 0, false),
    ...
    @Override
    public void onItemChildClick(ViewGroup viewGroup, @NonNull View view, int position) {
