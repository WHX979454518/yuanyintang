...
public class BGAImageView extends AppCompatImageView {
    ...
    public BGAImageView(@NonNull Context context) {
        this(context, null);
    }

    public BGAImageView(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BGAImageView(@NonNull Context context, AttributeSet attrs, int defStyle) {
    ...
    @NonNull
    public static RoundedBitmapDrawable getCircleDrawable(@NonNull Context context, @NonNull Bitmap src) {
        Bitmap dst;
    ...
    @NonNull
    public static RoundedBitmapDrawable getRoundedDrawable(@NonNull Context context, Bitmap bitmap, float cornerRadius) {
