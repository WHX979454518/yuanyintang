 ...
 */
package com.mxkj.yuanyintang.utils.photopicker.pw;
...
public class BGAPhotoFolderPw extends BGABasePopupWindow implements BGAOnRVItemClickListener {
    ...
    public BGAPhotoFolderPw(@NonNull Activity activity, View anchorView, Delegate delegate) {
    ...
    private class FolderAdapter extends BGARecyclerViewAdapter<BGAImageFolderModel> {
        ...
        @Override
        protected void fillData(@NonNull BGAViewHolderHelper helper, int position, @NonNull BGAImageFolderModel model) {
