...
public class MediaFile {
    ...
    public static MediaFileType getFileType(@NonNull String path) {
    ...
    //根据视频文件路径判断文件类型
    public static boolean isVideoFileType(@NonNull String path) {  //自己增加
    ...
    //根据音频文件路径判断文件类型
    public static boolean isAudioFileType(@NonNull String path) {  //自己增加
        MediaFileType type = getFileType(path);
        if (null != type) {
