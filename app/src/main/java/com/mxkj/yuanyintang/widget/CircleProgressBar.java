...
public class CircleProgressBar extends View {
    ...
    public CircleProgressBar(Context context, @Nullable AttributeSet attrs) {
        ...
        max = typedArray.getInteger(R.styleable.CustomProgressBar_maxBar , 100);
        roundColor = typedArray.getColor(R.styleable.CustomProgressBar_roundColorBar, Color.parseColor("#272728"));
        roundProgressColor = typedArray.getColor(R.styleable.CustomProgressBar_roundProgressColorBar ,Color.parseColor("#ffffff") );
        textColor = typedArray.getColor(R.styleable.CustomProgressBar_textColorBar , Color.GREEN);
        textSize = typedArray.getDimension(R.styleable.CustomProgressBar_textSizeBar , 55);
        roundWidth = typedArray.getDimension(R.styleable.CustomProgressBar_roundWidthBar , 10);
        textShow = typedArray.getBoolean(R.styleable.CustomProgressBar_textShowBar , true);
